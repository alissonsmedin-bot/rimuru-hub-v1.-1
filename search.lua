...
function Search:Create()
	...
	-- NO RESULTS
	--==================================================
	-- Fica FORA do Container.
	-- Não interfere no layout dos cards.
	--==================================================
...
function Search:DisconnectEvents()
	...
	for _, Connection in
		...
		if Connection
		and type(Connection.Disconnect)
			== "function" then
